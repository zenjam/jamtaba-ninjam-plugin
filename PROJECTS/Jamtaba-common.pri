...
HEADERS += NinjamPlugin/NpSocket.h
SOURCES += NinjamPlugin/NpSocket.cpp
SOURCES += NinjamPlugin/NpSocketServer.cpp
HEADERS += NinjamPlugin/NpSocketServer.h
SOURCES += NinjamPlugin/NpWebSocketServer.cpp
HEADERS += NinjamPlugin/NpWebSocketServer.h
HEADERS += NinjamPlugin/NpPipe.h
